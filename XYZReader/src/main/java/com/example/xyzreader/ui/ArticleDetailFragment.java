...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDrawInsetsCoordinatorLayout = (DrawInsetsCoordinatorLayout)
                mRootView.findViewById(R.id.draw_insets_coordinator_layout);
        ...
        mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                ...
                mPhotoContainerView.setTranslationY((int) (scrollY - scrollY / PARALLAX_FACTOR));
                updateStatusBar();
            }
        });
        ...
        if (mCursor != null) {
            ...
            bylineView.setText(Html.fromHtml(
                    DateUtils.getRelativeTimeSpanString(
                            ...
                            + "</font>"));
            articleContent = Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY)).toString();
            bodyView.setText(articleContent);
